package br.edu.marvin.repository;

import br.edu.marvin.MarvinApp;
import br.edu.marvin.config.Constants;
import br.edu.marvin.config.audit.AuditEventConverter;
import br.edu.marvin.domain.PersistentAuditEvent;
...
import static br.edu.marvin.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
